...
func init() {
	...
	// TODO 현재 man 2 syscalls 파싱하여 얻은 목록을 sys(#)와 tracepoint참고하여 생성래퍼함수 목록만들도록 리팩토링할 예정
	// for 추가 가공 없이 바로 tracepoint 후킹코드 생성가능하도록
	// 그러나 그냥 만들어진 목록에 대해 tracepoint 존재 여부 확인하는걸로. 뒤에서 체크한다
